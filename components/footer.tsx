...
export function Footer() {
  ...
  const shareText = `¡No te pierdas ${eventConfig.event.name}!`

  return (
    <footer id="contacto" className="border-t border-white/10 bg-black/50 py-12">
      <div className="container mx-auto px-4">
        <div className="text-center">
          <h3 className="mb-6 text-xl font-semibold text-white">Promociona este evento en</h3>
          ...
          <p className="text-sm text-white/40">© 2025 {eventConfig.brand} Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
